 ...
 * key, or compacted later in a single garbage collection step of all removed
 * entries. This garbage collection will need to be performed at any time the
 * array needs to be grown or the the map size or entry values are retrieved.
 * </p>
 *
 * <p>
...
public class SparseArray<E> implements Cloneable {
	protected static final int[] EMPTY_INT_ARR = new int[0];
	protected static final Object[] EMPTY_OBJ_ARR = new Object[0];
	...
	/**
	 * @hide Removes the mapping from the specified key, if there was any,
